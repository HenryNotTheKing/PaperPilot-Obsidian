...
| **PDF 划词解释** | 在 PDF 中选中任意文字，按 **Shift+T** 可快速翻译，按 **Shift+E** 可获得更宽窗口中的 Markdown 结构化详细解释，并自动附带更丰富的论文上下文 |
...
> **PDF 划词解释**中的 **Shift+T** 与 **Shift+E** 都复用上方 **Extraction model** 的配置，无需额外填写接口信息。
...
| 上下文窗口大小 | PDF 划词解释时，选中文本前后各取多少字符作为上下文（默认：500）。**Shift+E** 会自动在此基础上扩展为更大的上下文窗口，以生成更详细的解释。 |
